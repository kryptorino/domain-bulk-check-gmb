...
async function checkGoogleMyBusiness(domain, credentials) {
    try {
        ...
        // Try ONLY the business name first (most likely to succeed)
        const requestData = [{
        ...
        try {
            ...
            // If business name search fails, domain probably has no GMB
            console.log(`Search failed for "${businessName}":`, error.message);
        }
